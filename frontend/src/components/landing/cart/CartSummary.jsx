...
export function CartSummary({
  ...
  return (
    <div className="lg:w-96">
      <div className="mb-4">
        <h2 className="text-xl font-semibold text-gray-800">Resum de la comanda</h2>
      </div>
      ...
      <div className="bg-white rounded-md shadow-sm overflow-hidden sticky top-24">
        <div className="p-6 space-y-4">
          ...
          <div className="flex justify-between items-center">
            <div className="flex items-center">
              ...
              <button className="ml-1 text-gray-400 hover:text-gray-600 focus:outline-none" title="3% del subtotal">
                <Info className="h-4 w-4" />
              </button>
            </div>
            <span className="font-medium">{serviceCommission.toFixed(2)} €</span>
          </div>
          ...
          <div className="border-t pt-4 mt-2">
            <div className="flex justify-between items-center">
              ...
              <span className="font-bold text-2xl text-[#9A3E50]">{total.toFixed(2)} €</span>
            </div>
        ...
        <div className="p-6 bg-gray-50 border-t">
          ...
          <div className="mt-4 text-center">
            <a href="/" className="text-[#9A3E50] hover:text-[#7e3241] text-sm font-medium inline-flex items-center">
        ...
        <div className="p-6 bg-gray-50 border-t">
          ...
          <div className="flex items-center justify-between space-x-2">
            <div className="h-8 w-12 bg-white rounded shadow-sm flex items-center justify-center">
              <img src="/placeholder.svg?height=20&width=32" alt="Visa" className="h-5 w-auto" />
            </div>
            <div className="h-8 w-12 bg-white rounded shadow-sm flex items-center justify-center">
              <img src="/placeholder.svg?height=20&width=32" alt="Mastercard" className="h-5 w-auto" />
            </div>
            <div className="h-8 w-12 bg-white rounded shadow-sm flex items-center justify-center">
              <img src="/placeholder.svg?height=20&width=32" alt="American Express" className="h-5 w-auto" />
            </div>
            <div className="h-8 w-12 bg-white rounded shadow-sm flex items-center justify-center">
              <img src="/placeholder.svg?height=20&width=32" alt="PayPal" className="h-5 w-auto" />
            </div>
          </div>
        </div>
      </div>
