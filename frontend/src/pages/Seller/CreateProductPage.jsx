...
export default function CreateProduct() {
    ...
    useEffect(() => {
        if (formData.wine_type_id && formSectionRef.current) {
            ...
            <div className="flex-1 md:ml-[245px] p-4 md:p-8 pb-20 bg-gray-100 min-h-screen">
                <div className="max-w-4xl mx-auto">
                    ...
                    <form onSubmit={handleSubmit} className="flex flex-col gap-6">
                                ...
                                <div className="grid grid-cols-2 sm:grid-cols-3 md:grid-cols-5 gap-4">
                                    {wineTypes.map((wine) => (
                                        ...
                                        >
                                            ...
                                            />
                                            <div className="text-center text-xs">{wine.name}</div>
                                        </div>
                                    ))}
                                </div>
                                {errors.wine_type_id && (
                        ...
                        {formData.wine_type_id && (
                            <div ref={formSectionRef} className="flex flex-col md:flex-row justify-between bg-white p-8 rounded-lg shadow-md">
                                ...
                                <div className="md:w-2/3 w-full">
                                    ...
                                    <button
                                        type="submit"
                                        className="mt-6 w-full px-6 py-3 bg-[#FE8B96] text-[#3D2929] rounded-lg hover:bg-[#FFBEC5] transition-colors"
                                    >
